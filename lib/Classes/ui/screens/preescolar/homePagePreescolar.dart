...
class HomePagePreescolar extends StatelessWidget {
  const HomePagePreescolar({Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        title: Center(child: Image.asset("images/logos/logo.png", height: 70,)),
      ),
     body: ListView(
       children: [
         Principal(),
...
Widget build(BuildContext context) {
    return  StreamBuilder(
          stream: Firestore.instance.collection('preescolar').snapshots(),
